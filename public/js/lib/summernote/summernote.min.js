/*! Summernote v0.8.1 | (c) 2013-2015 Alan Hong and other contributors | MIT license */ ! function (a) {
    ...
    var m = {
        ...
        p = function () {
            var b = function (b) {
                ...
                F = m.isMSIE && m.browserVersion < 11 ? "&nbsp;" : "",
                G = function (a) {
    ...
    var r = function (b, c, d, e) {
        ...
        H = s.create(['<div class="note-popover popover in d-none">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join(""), function (a, b) {
